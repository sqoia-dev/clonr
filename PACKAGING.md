...
```
clustr-serverd-0.10.0-1.el9.x86_64.rpm
clustr-serverd-0.10.0-1.el8.x86_64.rpm
clustr-serverd-0.10.0-1.el10.x86_64.rpm
clustr-0.10.0-1.el9.x86_64.rpm
clustr-0.10.0-1.el8.x86_64.rpm
clustr-0.10.0-1.el10.x86_64.rpm
```
...
`github.ref_name` with the leading `v` stripped (e.g. tag `v0.10.0` → version `0.10.0`).
