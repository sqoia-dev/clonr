...
function BuildLogPanel({ buildId, open }: BuildLogPanelProps) {
  ...
  React.useEffect(() => {
    ...
    // TODO(UX-4-followup): BuildLogPanel is an intentional holdout from the
    // UX-4 multiplexed SSE migration. This stream uses a per-build URL and
    // delivers raw log lines, not typed state-sync events. Migrate once the
    // event bus supports streaming arbitrary text payloads per build ID.
