...
type DeployOpts struct {
	...
	// Logger is the per-deploy zerolog.Logger to use for this deployment.
	// When set, it is used instead of the package-level pkgLog so that
	// concurrent deployments produce correlated, non-interleaved log output.
