...
const NetworkPages = {
        ...
        return `
            <div class="page-header">
                <div>
                    ...
                    <div class="page-subtitle">Switch inventory for the cluster fabric. Inventory-only in v1 &mdash; clustr does not program switches via SNMP.</div>
                </div>
    ...
    _loadDefaultOpenSMConf() {
        const defaultConf = `# opensm.conf generated by clustr Network module
