...
// ListNodeIDsByEnclosureLabels delegates to the enclosures DB layer (#231).
func (a *DBAdapter) ListNodeIDsByEnclosureLabels(ctx context.Context, labels []string) ([]NodeID, error) {
	return a.db.ListNodeIDsByEnclosureLabels(ctx, labels)
}
